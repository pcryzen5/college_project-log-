...
class _AttendancePageState extends State<AttendancePage> {
  ...
  void calculateTotalLectures() {
    ...
    debugPrint(
        "Total number of lectures conducted till date for all subjects: $globalTotalLectures");
    debugPrint(
        "Total number of lectures attended till date for all subjects: $totalAttendedLectures");
  }
